...
class EstadosForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        // creates the form
        $this->form = new TQuickForm('form_Estados');
        ...
        $this->form->addQuickAction(_t('List'),  new TAction(array('EstadosList', 'onReload')), 'bs:list blue green');

        // vertical box container
        $container = new TVBox;
        $container->style = 'width: 90%';
        // $container->add(new TXMLBreadCrumb('menu.xml', __CLASS__));
        $container->add(TPanelGroup::pack('CADASTRO DE ESTADOS', $this->form));
