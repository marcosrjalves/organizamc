...
class LocaisList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->addQuickAction(_t('New'),  new TAction(array('LocaisForm', 'onEdit')), 'bs:plus-sign green');
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('LocaisForm', 'onEdit'));
    ...
    public function onTurnOnOff($param)
    {
        ...
        {
            TTransaction::open('organizamc');
            $user = Locais::find($param['id']);
            if ($user instanceof Locais)
            {
