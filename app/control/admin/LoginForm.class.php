...
class LoginForm extends TPage
{
    ...
    function __construct($param)
    {
        ...
        $btnnew = $this->form->addAction('Cadastre-se', new TAction(array('SystemUserFormForUsers', 'onClear')), '');
        $btnnew->class = 'btn btn-warning';
        $btnnew->style = 'height: 40px;width: 90%;display: block;margin: auto;font-size:17px;';
    ...
    public static function newUserMessage()
    {
        try
        {
            new TMessage('info', 'Novo usuário cadastrado. Já pode se logar');
        }
        catch (Exception $e)
        {
            new TMessage('error', $e->getMessage());
