 ...
 */
class FornecedorFormForUsers extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $this->form->addQuickAction(_t('List'),  new TAction(array('FornecedorListForUsers', 'onReload')), 'bs:list blue blue');
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                if ($object->aprovado == 'S')
                {
                    TEntry::disableField('form_Fornecedor', 'nome');
                    TEntry::disableField('form_Fornecedor', 'rua');
                    TEntry::disableField('form_Fornecedor', 'numero');
                    TEntry::disableField('form_Fornecedor', 'bairro');
                    TDBCombo::disableField('form_Fornecedor', 'municipio');
                    TDBCombo::disableField('form_Fornecedor', 'estado');
                    TDBCombo::disableField('form_Fornecedor', 'tipo');
                }
