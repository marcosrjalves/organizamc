 ...
 */
class ContratosFormForUsers extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $nome_fornecedor = new TDBCombo('nome_fornecedor', 'organizamc', 'Fornecedor', 'id', 'nome', 'nome');
        ...
        $this->form->addQuickAction(_t('List'),  new TAction(array('ContratosListForUsers', 'onReload')), 'bs:list blue blue');
