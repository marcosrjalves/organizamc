 ...
 */
class ContratosListForUsers extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->addQuickAction(_t('New'),  new TAction(array('ContratosFormForUsers', 'onEdit')), 'bs:plus-sign green');
    ...
    public function onSearch()
    {
        ...
        $data->id_usuario = TSession::getValue('userid');
        ...
        $data->id_casamento = $casamento[0]->id_usuario;
        ...
        TSession::setValue('ContratosList_filter_id_usuario',   TSession::getValue('userid'));
        ...
        if (isset($data->id_usuario) AND ($data->id_usuario)) {
            $filter = new TFilter('id_usuario', '=', TSession::getValue('userid')); // create the filter
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            $filter = new TFilter('id_usuario', '=', TSession::getValue('userid')); // create the filter
            TSession::setValue('ContratosList_filter_id_usuario', $filter);
            // TSession::setValue('ContratosList_filter_id_casamentonoivo',   $filter);
    ...
    public function show()
    {
        ...
        $casamento = $repository->load($criteria);
        $data->id_casamento = $casamento[0]->id_usuario;
        TSession::setValue('ContratosList_filter_id_casamento', $data->id_casamento);
        TSession::setValue('ContratosList_filter_id_usuario', TSession::getValue('userid'));
